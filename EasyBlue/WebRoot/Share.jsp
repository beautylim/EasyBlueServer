...
<body>
<h1 style="text-align:center;top:380px;font-size:48px;font-weight:bold;position:relative">EasyBlue统计您的最新步数为：<%=session.getAttribute("data") %></h1>
